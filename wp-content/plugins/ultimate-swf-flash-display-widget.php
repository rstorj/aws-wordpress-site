...
<?php
    ...
    public function widget($args, $instance) {
		...
		";}
		$data .= "<div class='copy' style='color:#ccc; font-size: 9px; '><a href='http://corporatecostcontrol.com/' title='visit us' target='_blank'>unemployment cost management</a></div>";
		echo $before_widget;
